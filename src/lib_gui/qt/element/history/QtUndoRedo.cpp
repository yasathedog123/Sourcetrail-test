	...
	:  m_historyHiddenAt(TimeStamp::now())
{
	...
	m_undoButton = new QtSearchBarButton(ResourcePaths::getGuiDirectoryPath().concatenate(L"undoredo_view/images/arrow_left.png"));
	m_undoButton->setObjectName(QStringLiteral("undo_button"));
	m_undoButton->setToolTip(QtActions::back().tooltip());
	m_undoButton->setEnabled(false);

	m_historyButton = new QtSearchBarButton(ResourcePaths::getGuiDirectoryPath().concatenate(L"undoredo_view/images/history.png"));
	...
	m_redoButton = new QtSearchBarButton(ResourcePaths::getGuiDirectoryPath().concatenate(L"undoredo_view/images/arrow_right.png"));
